...
Read `.claude/rules/infra.md` for the repo's Terraform conventions and pipeline before reviewing, and its **Deployment topology** section if the change alters what the infrastructure is.
