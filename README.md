...
[docs/deployment-environments.md](docs/deployment-environments.md); the
underlying AWS architecture is drawn in [docs/diagrams/](docs/diagrams/) and
described under "Deployment topology" in `.claude/rules/infra.md`.
