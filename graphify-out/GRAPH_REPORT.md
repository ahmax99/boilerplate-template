...
## Corpus Check
- 299 files · ~36,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1050 nodes · 1735 edges · 83 communities (58 shown, 25 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3042de1`
...
### Community 0 - "auth.ts"
Cohesion: 0.23
Nodes (6): env, COOKIE_OPTIONS, SESSION_CONFIG, cognitoClient, extends, $schema
...
### Community 2 - "cn"
Cohesion: 0.06
Nodes (50): geistMono, geistSans, RootLayout(), Button(), buttonVariants, ButtonLink(), Input(), Label() (+42 more)
...
Cohesion: 0.17
Nodes (9): GET, GET, GET, GET, GET, POST, createPostServer(), fetchPreSignedUrl() (+1 more)

### Community 6 - "ContactForm.tsx"
Cohesion: 0.23
Nodes (13): useErrorHandler(), handleApiError(), ContactForm(), ContactFormConfig, ContactFormProps, FieldConfig, useContactActions(), ContactFormModel (+5 more)
...
Cohesion: 0.06
Nodes (43): EditAccountPage(), metadata, AccountPage(), metadata, AuthorizedLayoutContent(), CreatePostPage(), metadata, metadata (+35 more)
...
Cohesion: 0.20
Nodes (7): GlobalErrorProps, OAuth2Start(), safeRelativePath(), mapToAppError(), stringifyUnknownError(), captureError(), catchSyncError()
...
Cohesion: 0.17
Nodes (23): GET, getOIDCClient(), AuthModel, CallbackParams, SessionData, createUser(), getValidTokenData(), handleCallback() (+15 more)
...
Cohesion: 0.38
Nodes (5): EmailModel, EmailUser, emailUserSchema, resend, SendEmailParams
...
Cohesion: 0.13
Nodes (21): dedupeErrorMessages(), Field(), FieldContent(), FieldError(), FieldErrorItem, FieldLabel(), FieldTitle(), fieldVariants (+13 more)
...
Cohesion: 0.21
Nodes (10): FormField(), AccountFormConfig, AccountFormProps, FieldConfig, FieldInput(), AccountFormModel, UpdateProfileSchema, FieldInput() (+2 more)
...
Cohesion: 0.24
Nodes (9): FormCard(), FieldConfig, PostForm(), PostFormConfig, PostFormProps, PostFormSchema, usePostActions(), CreatePostSchema (+1 more)

### Community 77 - "AppError"
Cohesion: 0.30
Nodes (4): ERROR_DISPLAY, ErrorStore, useErrorStore, AppError

### Community 78 - "useAccountActions.ts"
Cohesion: 0.24
...
## Knowledge Gaps
- **483 isolated node(s):** `auto-format.sh script`, `paths`, `protect-bash.sh script`, `stop-typecheck.sh script`, `bootstrap_labels.sh script` (+478 more)
...
- **Why does `env` connect `auth.ts` to `sendEmail.ts`, `cn`, `ContactForm.tsx`, `AppError`, `useAccountActions.ts`, `organizeImports`, `auth.ts`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `rules` connect `correctness` to `suspicious`, `linter`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `CommentForm.tsx`, `organizeImports`?**
