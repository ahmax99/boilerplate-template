...
- **SWC** for fast compilation - [Configuration Guide](../../docs/swc-configuration.md)
- **Hexagonal Architecture** - [Hexagonal Architecture Guide](../../docs/hexagonal-architecture.md)
