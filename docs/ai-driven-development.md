...
| Implement (UI) | `frontend-design` | Builds distinctive, production-grade Next.js / React + Tailwind + shadcn UI — avoids generic "AI slop" aesthetics. Use it for any `nextjs-boilerplate` component or page. |
