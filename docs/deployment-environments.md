...
| `secrets.TF_VAR_sentry_dsn`           | secret   | Manually set — prod Sentry project/environment DSN (Step 0).                                                                                                                 |
